...
import { Inter, JetBrains_Mono, Cormorant_Garamond, Poppins } from "next/font/google";
import "./globals.css";
...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body
        className={`${inter.variable} ${jetbrainsMono.variable} ${cormorantGaramond.variable} ${poppins.variable} antialiased`}
      >
        {children}
      </body>
    </html>
